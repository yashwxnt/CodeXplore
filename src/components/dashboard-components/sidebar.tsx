...
import { SIDENAV_ITEMS } from '@/app/dashboard/menu-constants';
    ...
    return (
        <aside className={asideStyle}>
            <div className="sidebar-top relative flex items-center px-3.5 py-5">
                {mounted && <SideBarLogo />}
                <h3 className={classNames("pl-2 font-bold text-2xl min-w-max text-sidebar-foreground font-brenet-regular",
